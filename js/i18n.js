...
const translations = {
  ar: {
    ...
    // Hero
    "hero.badge": "تطبيق مصري 100% للسائقين",
    ...
    "compare.bad.sub": "يوم مشتت ومتعب",
    "compare.bad.1": "8 طلبات بس في 9 ساعات",
    "compare.bad.2": "95 كم رايح جاي بدون ترتيب",
    "compare.bad.3": "3-4 طلبات فاشلة كل يوم",
    "compare.bad.4": "مش عارف كسبان ولا خسران",
    "compare.bad.5": "الطلبات مشتتة على 4 أماكن",
    "compare.good.title": "مع سكّة",
    "compare.good.sub": "يوم منظم ومربح",
    "compare.good.1": "18 طلب في 8 ساعات بس",
    "compare.good.2": "48 كم بمسار ذكي موفّر",
    "compare.good.3": "صفر طلبات فاشلة تقريباً",
    "compare.good.4": "بتعرف أرباحك لحظة بلحظة",
    "compare.good.5": "كل الطلبات في مكان واحد",
    ...
    "footer.contact.email": "support@sekka.app",
    "footer.contact.phone": "01000000000",
  ...
  en: {
    ...
    // Hero
    "hero.badge": "100% Egyptian App for Drivers",
    ...
    "compare.bad.sub": "Scattered and exhausting",
    "compare.bad.1": "Only 8 orders in 9 hours",
    "compare.bad.2": "95 km driven with no plan",
    "compare.bad.3": "3-4 failed deliveries daily",
    "compare.bad.4": "No idea if you're up or down",
    "compare.bad.5": "Orders spread across 4 places",
    "compare.good.title": "With Sekka",
    "compare.good.sub": "Organized and profitable",
    "compare.good.1": "18 orders in just 8 hours",
    "compare.good.2": "48 km with smart routing",
    "compare.good.3": "Nearly zero failed deliveries",
    "compare.good.4": "Know your earnings live",
    "compare.good.5": "All orders in one place",
