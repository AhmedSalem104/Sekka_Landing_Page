...
<img src="./assets/logo.png" alt="Sekka Logo" width="120" height="120" />
...
| Color | Hex | Usage |
|:-----:|:---:|-------|
| ![#FC5D01](https://via.placeholder.com/20/FC5D01/000000?text=+) **Primary** | `#FC5D01` | Buttons, links, interactive elements |
| ![#FFF0E6](https://via.placeholder.com/20/FFF0E6/000000?text=+) **Primary Light** | `#FFF0E6` | Secondary backgrounds |
| ![#D94E00](https://via.placeholder.com/20/D94E00/000000?text=+) **Primary Dark** | `#D94E00` | Pressed states |
| ![#FF8534](https://via.placeholder.com/20/FF8534/000000?text=+) **Gradient End** | `#FF8534` | Gradients |
| ![#2D3748](https://via.placeholder.com/20/2D3748/000000?text=+) **Navy** | `#2D3748` | Logo secondary color |
| ![#F7FAFC](https://via.placeholder.com/20/F7FAFC/000000?text=+) **Background** | `#F7FAFC` | Light mode background |
| ![#1A202C](https://via.placeholder.com/20/1A202C/000000?text=+) **Headline** | `#1A202C` | Primary text |
| ![#4A5568](https://via.placeholder.com/20/4A5568/000000?text=+) **Body** | `#4A5568` | Body text |
